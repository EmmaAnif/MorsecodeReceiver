...
${OBJECTDIR}/ProjectSource/MyService1.o: ProjectSource/MyService1.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/ProjectSource" 
	@${RM} ${OBJECTDIR}/ProjectSource/MyService1.o.d 
	@${RM} ${OBJECTDIR}/ProjectSource/MyService1.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"FrameworkHeaders" -I"ProjectHeaders" -I"u8g2Headers" -MMD -MF "${OBJECTDIR}/ProjectSource/MyService1.o.d" -o ${OBJECTDIR}/ProjectSource/MyService1.o ProjectSource/MyService1.c    -DXPRJ_FrameworkWith_u8g2=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -std=gnu99 -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/ProjectSource/MyService1.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
